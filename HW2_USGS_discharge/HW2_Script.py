# =======================================================================
# OCNG689.600
# Homework 2, Part 1: Script
# Created by: Kenji Miyajima
# Date: 2013-10-15
# -----------------------------------------------------------------------
# A script that retrieves the river discharge data from the USGS and reads
# the station number, amount of discharge, and calculate the annual mean
# and the standard deviation of the discharge.
# -----------------------------------------------------------------------
# Input:
...
plt.savefig('Kenji_Miyajima_HW2.pdf', dpi=300)
